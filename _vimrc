...
map <F3> :Tagbar<CR>
"autocmd BufReadPost *.go,*.cpp,*.c,*.h,*.hpp,*.cc call tagbar#autoopen() "tagbar自动开启
"autocmd BufReadPost *.go :Tagbar "tagbar自动开启
...
syntax on
au BufRead,BufNewFile,BufReadPost *.go set filetype=go
colorscheme molokai
